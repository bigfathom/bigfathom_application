...
/**
 * Collection of some basic tests for the notify module
 *
 * @author Frank Font
 */
class BasicNotifyTests extends \bigfathom\AbstractActionTestGroup
{
    ...
    function testSingleMailto()
    {
        ...
        try
        {
            ...
            module_load_include('php','bigfathom_notify','core/EmailHelper');

 ...
 * @author Frank Font
 */
class DeleteLocationPage extends \bigfathom\ASimpleFormPage
{
    ...
    function __construct($locationid)
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to delete location#$locationid!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        try
        {
            ...
            db_delete(DatabaseNamesHelper::$m_location_tablename)
              ->condition('id', $locationid)
              ->execute(); 
            //If we are here then we had success.
            $msg = 'Deleted location item#' . $locationid . " having shortname of '" . $myvalues['shortname'] . "'";
    ...
    function getForm($form, &$form_state, $disabled, $myvalues, $html_classname_overrides=NULL)
    {
        ...
        $buttontext = 'Delete Location From System';

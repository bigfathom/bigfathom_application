...
/**
 * This enables a user to declare importance of workitems
 *
 * @author Frank Font of Room4me.com Software LLC
 */
class ManageImportanceOfWorkPage extends \bigfathom\ASimpleFormPage
{
    ...
    public function __construct($projectid=NULL, $urls_override_arr=NULL)
    {
        ...
        $urls_arr['autofill_unlocked'] = 'bigfathom/project/autofill_unlocked';
    ...
    function getForm($form, &$form_state, $disabled, $myvalues, $html_classname_overrides=NULL)
    {
        try
        {
            ...
            drupal_add_js("$base_url/$module_path/form/js/ManageImportanceOfWorkTable.js");
            ...
            $form['data_entry_area1']["blurb"]    = array(
                ...
                '#markup' => "<p>"
                . "Assess the importance of each workitem to the successful achievement of the project mission and vision.  Disregard whether you are currently a participant in the workitem. Score by applying your personal opinion.  Changes are saved as you make them."
                . "</p>",
                '#suffix' => '</div>',
            );
            ...
            $newbundle = $this->m_oMapHelper->getWorkitem2ImportanceList($this->m_parent_projectid, $user->uid, $user->uid);//, $about_personid=NULL, $created_by_personid=NULL);
            ...
            {
                $default_importance_score = $record['importance'];
                ...
                if($status_terminal_yn != 1)
                {
                    ...
                    $is_level[0] = FALSE;
                    $noidea = FALSE;
                    $your_importance_assessment = NULL;
                    
                    if(!array_key_exists($workitemid, $self_assessment))
                    {
                        $noidea = TRUE;
                    } else {
                        $existing_importance = $self_assessment[$workitemid];
                        $your_importance_assessment = $existing_importance['importance'];
                        $importance_level = $existing_importance['importance_level'];
                        $is_level[$importance_level] = TRUE;
                    }
                    ...
                    $allowrowedit_yn = TRUE;    //everyone can edit their own!!!!! $has_project_owner_rights || $isowner || $is_systemadmin ? 1 : 0;
                    if($allowrowedit_yn)
                    {
                    ...
                    $rows   .= "\n"
                            ...
                            . '<td>' . $default_importance_score.'</td>'
            ...
            $form["data_entry_area1"]['table_container']['grid'] = array('#type' => 'item',
                    ...
                    . '<th class="nowrap" colname="is_level4" datatype="boolean" ' . $editable_col_flag . ' >'
                        . '<span title="This workitem is VERY important to the success of this projects mission and vision">'
                        .t('High').'</span></th>'
                
                    . '<th class="nowrap" colname="is_level3" datatype="boolean" ' . $editable_col_flag . ' >'
                        . '<span title="This workitem is MODERATELY important to the success of the project mission and vision">'
                        .t('Moderate').'</span></th>'
                
                    . '<th class="nowrap" colname="is_level2" datatype="boolean" ' . $editable_col_flag . ' >'
                        . '<span title="This workitem is NOT VERY important to the success of the project mission and vision">'
                        .t('Low').'</span></th>'
                
                    . '<th class="nowrap" colname="is_level1" datatype="boolean" ' . $editable_col_flag . ' >'
                        . '<span title="This workitem is MINIMALLY important to the success of the project mission and vision">'
                        .t('Minimal').'</span></th>'
                
                    . '<th class="nowrap" colname="is_level0" datatype="boolean" ' . $editable_col_flag . ' >'
                        . '<span title="This workitem is NOT RELEVANT to the success of the project mission and vision">'
                        .t('None!').'</span></th>'
                
                    . '<th class="nowrap" colname="is_unknown" datatype="boolean" ' . $editable_col_flag . ' >'
                        . '<span title="You have not considered your importance for this workitem">'
                        .t('Unknown').'</span></th>'
                
                    . '<th class="nowrap" colname="importance" datatype="double" ' . $editable_col_flag . ' named_validator="[0,100]">'
                        . '<span title="Your Importance Score Assessment in range [0,100] where 0=no importance, 100=maximal importance">'
                        .t('YISA').'</span></th>'
                    ...
                    . '<th class="nowrap" colname="default_importance" datatype="double">'
                     . '<span title="Default Importance Score in range [0,100] where 0=no importance, 100=maximal importance">'
                        .t('DIS').'</span></th>'

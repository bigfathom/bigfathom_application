...
/**
 * Delete Project Communication
 *
 * @author Frank Font
 */
class DeleteProjectCommentPage extends \bigfathom\ASimpleFormPage
{
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            ...
            $resultbundle = $this->m_oPageHelper->deleteProjectCommunication($matchcomid,$this_uid);
            drupal_set_message($resultbundle['message']);
        }
        catch(\Exception $ex)
        {
            $msg = t('Failed to update ' . $myvalues['project_nm']
                      . " project at step $step because " . $ex->getMessage());
            error_log("$msg\n" 
            ...
            , $html_classname_overrides=NULL)
    {
        ...
        $buttontext = 'Delete Project Communication From System';

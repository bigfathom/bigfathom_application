...
/**
 * View details of a use case entry
 *
 * @author Frank Font
 */
class ViewUseCasePage extends \bigfathom\ASimpleFormPage
{
    protected $m_usecaseid  = NULL;
    protected $m_urls_arr    = NULL;
    protected $m_oPageHelper = NULL;
    
    function __construct($usecaseid, $urls_override_arr=NULL)
    {
        ...
        $this->m_oPageHelper = new \bigfathom\UseCasePageHelper($urls_arr,NULL);
    }

 ...
 * @author Frank Font
 */
class AddGroupPage extends \bigfathom\ASimpleFormPage
{
    ...
    public function __construct()
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to add a group!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            $main_qry = db_insert(DatabaseNamesHelper::$m_group_tablename)
                ->fields(array(
                  'group_nm' => strtoupper($myvalues['group_nm']),
            ...
            $msg = 'Added ' . $myvalues['group_nm'];
            drupal_set_message($msg);
        }
        catch(\Exception $ex)
        {
            $msg = t('Failed to add ' . $myvalues['group_nm']

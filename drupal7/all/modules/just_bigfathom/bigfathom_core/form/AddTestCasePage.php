...
/**
 * Add a new test case item
 *
 * @author Frank Font
 */
class AddTestCasePage extends \bigfathom\ASimpleFormPage
{
    ...
    public function __construct($urls_override_arr=NULL, $projectid=NULL)
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to add a testcase!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            ...
            $resultbundle = $this->m_oPageHelper->createTestcase($this->m_projectid, $myvalues);

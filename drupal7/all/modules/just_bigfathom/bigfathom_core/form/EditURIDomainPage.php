 ...
 * @author Frank Font
 */
class EditURIDomainPage extends \bigfathom\ASimpleFormPage
{
    ...
    function __construct($uridomain)
    {
        if (!isset($uridomain) || is_numeric($uridomain)) {
            throw new \Exception("Missing or invalid uridomain value = " . $uridomain);
        }
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to edit uridomain '$uridomain'!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        try
        {
            $original_remote_uri_domain = $myvalues['original_remote_uri_domain'];
            $result_bundle = $this->m_oWriteHelper->updateURIDomainItem($original_remote_uri_domain, $myvalues);

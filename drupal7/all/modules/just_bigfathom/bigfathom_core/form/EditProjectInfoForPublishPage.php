...
/**
 * Edit project info and publish it
 *
 * @author Frank Font
 */
class EditProjectInfoForPublishPage extends \bigfathom\ASimpleFormPage
{
    ...
    {
        return $this->m_oPageHelper->getPublicationFieldValues($this->m_projectid);
    }
    ...
    function updateDatabase($form, $myvalues)
    {
        try
        {
            $resultbundle = $this->m_oWriteHelper->publishProjectInfo($this->m_projectid,$myvalues);
        ...
        {
            $msg = t('Failed to update project#' . $this->m_projectid
            ...
            , $html_classname_overrides=NULL)
    {
        ...
        $form = $this->m_oPageHelper->getPublishForm('E',$form
        ...
        $form['data_entry_area1']['action_buttons']['create'] = array(
            ...
            '#value' => t('Publish This Project Information'),
            '#disabled' => FALSE
        );

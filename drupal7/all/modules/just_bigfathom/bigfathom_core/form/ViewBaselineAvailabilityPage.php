...
/**
 * View details of a baseline_availability entry
 *
 * @author Frank Font
 */
class ViewBaselineAvailabilityPage extends \bigfathom\ASimpleFormPage
{
    protected $m_baseline_availabilityid  = NULL;
    protected $m_urls_arr    = NULL;
    protected $m_oPageHelper = NULL;
    
    function __construct($baseline_availabilityid, $urls_override_arr=NULL)
    {

 ...
 * @author Frank Font
 */
class DeleteUseCasePage extends \bigfathom\ASimpleFormPage
{
    ...
    function __construct($usecaseid)
    {
        ...
        $urls_arr = array();
        $urls_arr['return'] = 'bigfathom/sitemanage/usecase';
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to delete usecase#$usecaseid!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        try
        {
            ...
            $usecaseid = $myvalues['id'];
            $resultbundle = $this->m_oPageHelper->deleteUsecase($usecaseid);
            ...
            $msg = 'Deleted usecase item#' . $usecaseid . " having name of '" . $myvalues['usecase_nm'] . "'";
        ...
        {
            $msg = t('Failed to delete ' . $myvalues['usecase_nm']
    ...
    function getForm($form, &$form_state, $disabled, $myvalues, $html_classname_overrides=NULL)
    {
        ...
        $buttontext = 'Delete Use Case From System';

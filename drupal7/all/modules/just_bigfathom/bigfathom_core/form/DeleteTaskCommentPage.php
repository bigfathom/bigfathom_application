...
/**
 * Delete Task Communication
 *
 * @author Frank Font
 */
class DeleteTaskCommentPage extends \bigfathom\ASimpleFormPage
{
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            ...
            $resultbundle = $this->m_oPageHelper->deleteTaskComment($matchcomid,$this_uid);
            drupal_set_message($resultbundle['message']);
        }
        catch(\Exception $ex)
        {
            $msg = t('Failed to update ' . $myvalues['workitem_nm']
                      . " task at step $step because " . $ex->getMessage());
            error_log("$msg\n" 
            ...
            , $html_classname_overrides=NULL)
    {
        ...
        $buttontext = 'Delete Task Communication From System';

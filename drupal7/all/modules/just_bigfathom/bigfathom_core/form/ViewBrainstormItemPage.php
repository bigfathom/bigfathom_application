...
/**
 * View details of a brainstorm topic
 *
 * @author Frank Font
 */
class ViewBrainstormItemPage extends \bigfathom\ASimpleFormPage
{
    protected $m_brainstormid   = NULL;
    protected $m_urls_arr       = NULL;
    protected $m_oPageHelper    = NULL;
    protected $m_brainstorm_item_tablename = 'bigfathom_brainstorm_item';
    
    function __construct($brainstormid, $projectid=NULL, $urls_override_arr=NULL)
    {
        $this->m_oContext = \bigfathom\Context::getInstance();
        if (!isset($brainstormid) || !is_numeric($brainstormid)) {
            throw new \Exception("Missing or invalid id value = " . $brainstormid);
        }
        $this->m_brainstormid = $brainstormid;
        $urls_arr = [];
    ...
    {
        return $this->m_oPageHelper->getFieldValues($this->m_brainstormid);
    }

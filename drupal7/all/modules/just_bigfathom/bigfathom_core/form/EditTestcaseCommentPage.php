...
/**
 * Edit Test Case Communication
 *
 * @author Frank Font
 */
class EditTestcaseCommentPage extends \bigfathom\ASimpleFormPage
{
    ...
    protected $m_parent_page        = NULL;
    
    function __construct($comid, $urls_arr=NULL, $in_dialog=FALSE)
    {
    ...
    function updateDatabase($form, $myvalues)
    {
        try
        {
            ...
            $resultbundle = $this->m_oPageHelper->updateTestcaseComment($matchcomid, $myvalues);
            ...
            , $html_classname_overrides=NULL)
    {
        ...
        $new_form['data_entry_area1']['action_buttons']['create'] = array(
            ...
            '#value' => t('Save Test Case Comment Updates'),
            '#disabled' => FALSE
        );

 ...
 * @author Frank Font
 */
class AddExternalResourcePage extends \bigfathom\ASimpleFormPage
{
    ...
    public function __construct()
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to add a external resource!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            $main_qry = db_insert(DatabaseNamesHelper::$m_external_resource_tablename)->fields(array(
    ...
    function getForm($form, &$form_state, $disabled, $myvalues_override)
    {
        ...
        $new_form['data_entry_area1']['action_buttons']['create'] = array('#type' => 'submit'
                ...
                , '#value' => t('Add This External Resource'));

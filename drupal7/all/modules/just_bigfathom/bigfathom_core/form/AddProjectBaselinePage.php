...
/**
 * Add a new projbaseline item
 *
 * @author Frank Font
 */
class AddProjectBaselinePage extends \bigfathom\ASimpleFormPage
{
    ...
    public function __construct($urls_override_arr=NULL, $projectid=NULL)
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to add a projbaseline!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            ...
            $resultbundle = $this->m_oPageHelper->createProjectBaseline($this->m_projectid, $myvalues);
    ...
    function getForm($form, &$form_state, $disabled, $myvalues_override)
    {
        ...
        $new_form['data_entry_area1']['action_buttons']['create'] = array('#type' => 'submit'
                ...
                , '#value' => t('Add This Project Baseline'));

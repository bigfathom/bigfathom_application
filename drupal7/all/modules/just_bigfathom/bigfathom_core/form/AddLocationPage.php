 ...
 * @author Frank Font
 */
class AddLocationPage extends \bigfathom\ASimpleFormPage
{
    ...
    public function __construct()
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to add a location!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            $main_qry = db_insert(DatabaseNamesHelper::$m_location_tablename)->fields(array(
            ...
            $msg = 'Added location "' . $myvalues['shortname'] . '"';

 ...
 * @author Frank Font
 */
class ViewTaskPage extends \bigfathom\ASimpleFormPage
{
    protected $m_task_id     = NULL;
    protected $m_urls_arr    = NULL;
    protected $m_oPageHelper = NULL;
    
    function __construct($task_id, $projectid=NULL, $urls_arr=NULL)
    {
        if (!isset($task_id) || !is_numeric($task_id)) {
            throw new \Exception("Missing or invalid task_id value = " . $task_id);
        }
        ...
        $this->m_oPageHelper = new \bigfathom\TaskPageHelper($urls_arr);
    }

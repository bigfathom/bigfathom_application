...
/**
 * View details of a URI Domain entry
 *
 * @author Frank Font
 */
class ViewURIDomainPage extends \bigfathom\ASimpleFormPage
{
    protected $m_uridomain  = NULL;
    protected $m_urls_arr    = NULL;
    protected $m_oPageHelper = NULL;
    
    function __construct($uridomain, $urls_override_arr=NULL)
    {
        $this->m_oContext = \bigfathom\Context::getInstance();
        if (!isset($uridomain) || is_numeric($uridomain)) {
            throw new \Exception("Missing or invalid domain value = " . $uridomain);
        }
        $this->m_uridomain = $uridomain;
        $urls_arr = [];
    ...
    {
        return $this->m_oPageHelper->getFieldValues($this->m_uridomain);
    }

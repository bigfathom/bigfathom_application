...
/**
 * Delete Sprint Communication
 *
 * @author Frank Font
 */
class DeleteSprintCommentPage extends \bigfathom\ASimpleFormPage
{
    ...
    //protected $m_map_tag2sprint_tablename = 'bigfathom_map_tag2sprint';
    //protected $m_map_role2sprint_tablename = 'bigfathom_map_role2sprint';
    ...
    function __construct($comid, $urls_arr=NULL)
    {
        ...
        $this->m_comid = $comid;
        $record = $this->m_oMapHelper->getSprintCommunicationContext($this->m_comid);
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        try
        {
            ...
            $resultbundle = $this->m_oPageHelper->deleteSprintComment($matchcomid,$this_uid);
            drupal_set_message($resultbundle['message']);
        }
        catch(\Exception $ex)
        {
            $msg = t('Failed to update ' . $myvalues['sprint_nm']
                      . " sprint at step $step because " . $ex->getMessage());
            error_log("$msg\n" 
            ...
            , $html_classname_overrides=NULL)
    {
        ...
        $buttontext = 'Delete Sprint Communication From System';

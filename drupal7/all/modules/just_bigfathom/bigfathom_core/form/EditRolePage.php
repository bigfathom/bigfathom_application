 ...
 * @author Frank Font
 */
class EditRolePage extends \bigfathom\ASimpleFormPage
{
    ...
    function __construct($role_nm)
    {
        ...
        {
            global $user;
            error_log("HACKING WARNING: uid#{$user->uid} attempted to edit role $role_nm!!!");
    ...
    function updateDatabase($form, $myvalues)
    {
        ...
        {
            $role_id = $myvalues['id'];
            db_update($this->m_role_tablename)->fields(array(
            ...
            $msg = 'Saved update for ' . $myvalues['role_nm'];
            drupal_set_message($msg);
        }
        catch(\Exception $ex)
        {
            $msg = t('Failed to update ' . $myvalues['role_nm']
